...
else
{
    ...
    {
        $renderer=$this->detail->components['form']['renderer'];
        $obj=new $renderer($this->detail->form);
        print $obj->render();
    }
    if($this->detail->config['grid'] and (!$this->detail->config['form'] or strpos($this->detail->form->mode,'multi')===false))
    {
        $renderer=$this->detail->components['grid']['renderer'];
        $obj=new $renderer($this->detail->grid);
        print $obj->render();
    }
    if($this->detail->config['search'])
    {
        $renderer=$this->detail->components['search']['renderer'];
        $obj=new $renderer($this->detail->search);
        print $obj->render();
    }
