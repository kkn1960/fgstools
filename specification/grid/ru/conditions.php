...
$ra['conditions']=array();
$ra['conditions'][]=array('load'=>false,'action'=>'update','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;update=%1$d&amp;key=%2$s" class="icon_edit" title="Редактировать" ></a>');
$ra['conditions'][]=array('load'=>false,'action'=>'remove','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;remove=%1$d&amp;key=%2$s" class="icon_delete" title="Удалить" ></a>');
$ra['conditions'][]=array('load'=>false,'action'=>'copy','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;copy=%1$d&amp;key=%2$s" class="icon_copy" title="Копировать" ></a>');
...
$column['conditions'][1]=array('rowid'=>5731,'component'=>'ColumnLookup','header'=>'Тип','sid'=>'condition_type','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('common'=>'общее условие','input'=>'условие ввода','row'=>'условие  для  записи')),'field'=>'condition_type','hidden'=>'0','type'=>'varchar','list_sid'=>'ConditionType','renderer'=>'option');
$column['conditions'][2]=array('rowid'=>5732,'component'=>'ColumnText','header'=>'Ошибка','sid'=>'condition_error','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'condition_error','hidden'=>'0','calculate'=>'0');
