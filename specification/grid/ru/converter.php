...
$ra['converter']=array();
$ra['converter'][]=array('load'=>false,'action'=>'update','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;update=%1$d&amp;key=%2$s" class="icon_edit" title="Редактировать" ></a>');
$ra['converter'][]=array('load'=>false,'action'=>'remove','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;remove=%1$d&amp;key=%2$s" class="icon_delete" title="Удалить" ></a>');
$ra['converter'][]=array('load'=>false,'action'=>'copy','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;copy=%1$d&amp;key=%2$s" class="icon_copy" title="Копировать" ></a>');
$rsa['converter']=array();
...
$column['converter'][1]=array('rowid'=>5753,'component'=>'ColumnLookup','header'=>'Тип','sid'=>'converter_type','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('filter'=>'фильтр','converter'=>'конвертор')),'field'=>'converter_type','hidden'=>'0','type'=>'varchar','list_sid'=>'ConverterType','renderer'=>'option');
$column['converter'][2]=array('rowid'=>5765,'component'=>'ColumnLookup','header'=>'Статический метод ?','sid'=>'converter_static','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('0'=>'нет','1'=>'да')),'field'=>'converter_static','hidden'=>'0','type'=>'tinyint','list_sid'=>'YesNo','renderer'=>'option');
