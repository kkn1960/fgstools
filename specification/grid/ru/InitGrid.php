...
$ra['InitGrid']=array();
$rsa['InitGrid']=array();
$rsa['InitGrid'][]=array('action'=>'init_detail','renderer'=>'RowSetAction','immediate'=>0,'view'=>'<button type="submit" name="init_detail"  title="Добавить поля" ><span style="margin:0 -5px -3px -0px;" class="icon_add"></span></button>');
$column['InitGrid']=array();
$column['InitGrid'][0]=array('rowid'=>193,'component'=>'ColumnLink','header'=>'Название поля','sid'=>'field_name','hidden'=>'0','calculate'=>'0','renderer'=>'FieldLink','field'=>'field_name','type'=>'varchar');
$column['InitGrid'][1]=array('rowid'=>195,'save'=>'1','component'=>'ColumnText','header'=>'Тип','sid'=>'field_type','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'field_type','hidden'=>'0','calculate'=>'0');
$column['InitGrid'][2]=array('rowid'=>194,'save'=>'1','component'=>'ColumnText','header'=>'Компонент колонки','sid'=>'field_column','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'field_column','hidden'=>'0','calculate'=>'0');
$column['InitGrid'][3]=array('rowid'=>197,'save'=>'1','component'=>'ColumnText','header'=>'Заголовок','sid'=>'field_label','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'field_label','hidden'=>'0','calculate'=>'0');
$column['InitGrid'][4]=array('rowid'=>196,'save'=>'1','component'=>'ColumnText','header'=>'Список','sid'=>'field_list','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'field_list','hidden'=>'0','calculate'=>'0');
