...
$ra['tables']=array();
$ra['tables'][]=array('load'=>false,'action'=>'update','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;update=%1$d&amp;key=%2$s" class="icon_edit" title="Редактировать" ></a>');
...
$column['tables']=array();
$column['tables'][0]=array('rowid'=>356,'component'=>'ColumnText','header'=>'Имя','sid'=>'table_name','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'table_name','hidden'=>'0','calculate'=>'0');
$column['tables'][1]=array('rowid'=>358,'component'=>'ColumnText','header'=>'Первичный ключ','sid'=>'table_primary_key','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'table_primary_key','hidden'=>'0','calculate'=>'0');
$column['tables'][2]=array('rowid'=>5774,'component'=>'ColumnText','header'=>'Уникальный ключ','sid'=>'table_unique_key','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'table_unique_key','hidden'=>'0','calculate'=>'0');
$column['tables'][3]=array('rowid'=>360,'component'=>'ColumnText','header'=>'Таблица master','sid'=>'table_master','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'table_master','hidden'=>'0','calculate'=>'0');
$column['tables'][4]=array('rowid'=>359,'component'=>'ColumnLookup','header'=>'Системная таблица ?','sid'=>'table_system','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('0'=>'нет','1'=>'да')),'field'=>'table_system','hidden'=>'0','type'=>'tinyint','align'=>'left','list_sid'=>'YesNo','renderer'=>'option');
$button['tables']=array();