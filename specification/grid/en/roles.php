...
$ra['roles']=array();
$ra['roles'][]=array('load'=>false,'action'=>'update','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;update=%1$d&amp;key=%2$s" class="icon_edit" title="Edit" ></a>');
$ra['roles'][]=array('load'=>false,'action'=>'remove','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;remove=%1$d&amp;key=%2$s" class="icon_delete" title="Remove" ></a>');
$ra['roles'][]=array('load'=>false,'action'=>'copy','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;copy=%1$d&amp;key=%2$s" class="icon_copy" title="Copy" ></a>');
$rsa['roles']=array();
...
$column['roles'][1]=array('rowid'=>490,'component'=>'ColumnText','header'=>'Name','sid'=>'role_name','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'role_name','hidden'=>'0','calculate'=>'0');
$column['roles'][2]=array('rowid'=>491,'component'=>'ColumnLookup','header'=>'Internal  role ?','sid'=>'role_internal','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('0'=>'no','1'=>'yes')),'field'=>'role_internal','hidden'=>'0','type'=>'tinyint','list_sid'=>'YesNo','renderer'=>'option');
$column['roles'][3]=array('rowid'=>492,'component'=>'ColumnLookup','header'=>'Client role ?','sid'=>'role_client','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('0'=>'no','1'=>'yes')),'field'=>'role_client','hidden'=>'0','type'=>'tinyint','list_sid'=>'YesNo','renderer'=>'option');
$column['roles'][4]=array('rowid'=>493,'component'=>'ColumnLookup','header'=>'Active ?','sid'=>'role_active','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('0'=>'no','1'=>'yes')),'field'=>'role_active','hidden'=>'0','type'=>'tinyint','list_sid'=>'YesNo','renderer'=>'option');
$button['roles']=array();