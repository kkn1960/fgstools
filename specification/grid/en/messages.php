...
$ra['messages']=array();
$ra['messages'][]=array('load'=>false,'action'=>'update','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;update=%1$d&amp;key=%2$s" class="icon_edit" title="Edit" ></a>');
$ra['messages'][]=array('load'=>false,'action'=>'remove','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;remove=%1$d&amp;key=%2$s" class="icon_delete" title="Remove" ></a>');
$ra['messages'][]=array('load'=>false,'action'=>'copy','renderer'=>'RowAction','immediate'=>0,'view'=>'<a href="%3$s&amp;copy=%1$d&amp;key=%2$s" class="icon_copy" title="Copy" ></a>');
$rsa['messages']=array();
...
$column['messages'][0]=array('rowid'=>288,'component'=>'ColumnText','header'=>'Abbreviation','sid'=>'msg_abbr','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'msg_abbr','hidden'=>'0','calculate'=>'0');
$column['messages'][1]=array('rowid'=>5597,'component'=>'ColumnText','header'=>'Text in english','sid'=>'msg_en','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'msg_en','hidden'=>'0','calculate'=>'0');
$column['messages'][2]=array('rowid'=>5598,'component'=>'ColumnText','header'=>'Text in russian','sid'=>'msg_ru','hidden'=>'0','renderer'=>'text','type'=>'varchar','field'=>'msg_ru','hidden'=>'0','calculate'=>'0');
$column['messages'][3]=array('rowid'=>292,'component'=>'ColumnLookup','header'=>'System ?','sid'=>'msg_system','hidden'=>'0','join_lookup'=>0,'relation'=>'0','list'=>array('options'=>array('0'=>'no','1'=>'yes')),'field'=>'msg_system','hidden'=>'0','type'=>'tinyint','align'=>'left','list_sid'=>'YesNo','renderer'=>'option');
