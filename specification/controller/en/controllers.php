...
$config['master']['components']['form'] =array('class'=>'Form','sid'=>'controller','display'=>0,'renderer'=>'FgsFormView','hide'=>1);
$config['master']['components']['grid'] =array('class'=>'Grid','sid'=>'controllers','display'=>1,'renderer'=>'FgsGridView','hide'=>0,'multimode_hide'=>0);
$config['master']['components']['search'] =array('class'=>'Search','sid'=>'SearchController','display'=>1,'renderer'=>'FgsSearchView','hide'=>0);
...
$config['detail']['components']['form'] =array('class'=>'Form','sid'=>'unit','display'=>1,'renderer'=>'FgsFormView','hide'=>0);
$config['detail']['components']['grid'] =array('class'=>'Grid','sid'=>'units','display'=>1,'renderer'=>'FgsGridView','hide'=>0,'multimode_hide'=>0);
