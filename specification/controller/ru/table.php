...
$config['master']['components']['form'] =array('class'=>'Form','sid'=>'tables','display'=>1,'renderer'=>'FgsFormView','hide'=>0);
$config['master']['components']['grid'] =array('class'=>'Grid','sid'=>'tables','display'=>1,'renderer'=>'FgsGridView','hide'=>0,'multimode_hide'=>0);
$config['master']['components']['search'] =array('class'=>'Search','sid'=>'SearchTable','display'=>1,'renderer'=>'FgsSearchView','hide'=>0);
...
$config['detail']['components']['form'] =array('class'=>'Form','sid'=>'field','display'=>1,'renderer'=>'FgsFormView','hide'=>0);
$config['detail']['components']['grid'] =array('class'=>'Grid','sid'=>'fields','display'=>1,'renderer'=>'FgsGridView','hide'=>0,'multimode_hide'=>0);
